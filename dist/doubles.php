...
<div class="container">
                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <div class="card-body">
                        <form method="post" action="">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputfname" type="name" placeholder="playerid3" name="pid3" required />
                                <label for="inputlname">Playerid 3</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputfname" type="name" placeholder="playerid4" name="pid4" required />
    ...
    if (isset($_POST['submit'])) {
        ...
        $insertQuery = "INSERT INTO singles(mid,tid,level,catid,mdate,mtime,pid1,pid2,pid3,pid4,score,win,timestamp) VALUES ('$mid', '$tid', '$level', '$catid', '$mdate', '$mtime', '$pid1', '$pid2', '$pid3', '$pid4',  '$score', '$win', '$timestamp')";
